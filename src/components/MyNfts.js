  ...
  return (
    <section className="w-screen relative h-fit mb-10">
      <Sheet>
        ...
        <div className={'gap-[20px] mb-[20px] md:grid flex   lg:grid-cols-3 md:grid-cols-2 max-md:overflow-scroll'} lg='3' md='2' def='1'>
          <Cards title='Wallet Address'><Text type={'text'} className='text-white max-md:break-words '>{address}</Text></Cards>
        ...
        <div className='gap-y-[20px] gap-x-[20px] mb-[20px] md:grid md:grid-cols-2 lg:grid-cols-3 flex overflow-scroll' >
