...
const Explore = () => {
  return (
    <section className='relative'>
        ...
        <Grid className={'gap-20 mb=20px'}>
            <Card></Card>
            <Card></Card>
            <Card></Card>
            <Card></Card>
        </Grid>
        <Text type={'title'} className={'text-white mx-auto w-fit '}>Explore our NFT collection!</Text>
        ...
        <div className='relative rounded-[20px] w-[300px] mx-auto'><input className='w-full h-full rounded-[20px] bg-[#EEEEEE66] py-[10px] pl-[36px]' placeholder='Search'></input></div>
